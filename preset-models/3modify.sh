...
cat tempfiles/config_ipv6 >> package/default-settings/files/zzz-default-settings
cat tempfiles/config_theme >> package/default-settings/files/zzz-default-settings
